...
export default function HeroFormSignUpForm() {
  return (
    <>
      {/* Hero */}
      <div className="relative bg-gradient-to-bl from-primary-foreground via-primary-foreground to-background px-3">
        <div className="container py-24 sm:py-32 lg:px-16">
          {/* Grid */}
